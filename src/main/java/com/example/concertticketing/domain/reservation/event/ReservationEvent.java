...
public record ReservationEvent(int seatNo, Long memberId, Long price, SeatCompensation seat) {
    ...
    public static ReservationEvent from(Reservation reservation, SeatCompensation seat) {
        return new ReservationEvent(reservation.getSeatNo(), reservation.getMemberId(), reservation.getPrice(), seat);
    }
}